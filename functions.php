...
function html5blank_styles()
{
    ...
    wp_enqueue_style('hover'); // Hover
    
    wp_register_style('button', get_template_directory_uri() . '/css/button.css', array(), '1.0', 'all');
    wp_enqueue_style('button'); // Button
    
    wp_register_style('form', get_template_directory_uri() . '/css/form.css', array(), '1.0', 'all');
    wp_enqueue_style('form'); // Form
    ...
    wp_register_style('layerslider', get_template_directory_uri() . '/layerslider/css/layerslider.css', array(), '1.0', 'all');
    wp_enqueue_style('layerslider'); // Responsive
